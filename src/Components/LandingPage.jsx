...
function LandingPage() {
  ...
  const features = [
    {
      title: "User Friendly",
      description: "Get the best experience here, away from boring pages.",
    },
    {
      title: "Interactive Community",
      description: "Connect and interact with like-minded developers.",
    },
    {
      title: "Effective Answers",
      description: "Get precise and valuable answers from the community.",
    },
    {
      title: "Create Groups",
      description:
        "Form or join groups to discuss and solve coding challenges.",
    },
    {
      title: "Language Control",
      description: "Switch languages to match your preference and comfort.",
    },
    {
      title: "Security",
      description: "Your data and interactions are securely managed.",
    },
  ];
    ...
    >
      ...
      <div className="bg-[url('./assets/img/astronaut-bg.png')] bg-no-repeat bg-center bg-auto flex flex-col items-center justify-center text-center h-[110vh]">
        <h2 className="text-4xl md:text-5xl font-bold mb-6">
          ...
          <span className="text-[#7BF91A]">One stop</span> solution for dev's
          doubts
        </h2>
        <p className="max-w-2xl mb-8">
          Inquiro helps programmers and developers at any point of the learning
          curve to easily understand and tackle their problems with a skilled
          community.
        </p>
        <div className="flex space-x-4">
          ...
          <button
            className={`py-2 px-6 rounded-md cursor-pointer border font-medium hover:bg-transparent ${
              siteMode === "dark"
          ...
          <button
            ...
            className={`py-2 px-6 cursor-pointer rounded-md font-medium ${
              siteMode === "dark"
      ...
      <div className="px-4 py-12 max-w-6xl mx-auto">
        <h3 className="text-2xl font-bold text-center mb-12">
          ...
          <span className="text-[#737373] font-normal text-lg">
            Your everyday doubt-solving community
          </span>
        </h3>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features
            .slice(0, window.innerWidth < 768 ? 3 : features.length)
            .map((feature, index) => (
              <div
                key={index}
      ...
      <div className="px-4 py-12 max-w-6xl mx-auto">
        <h3 className="text-2xl font-bold text-center mb-12">
          ...
          <br></br>
          <span className="text-[#737373] font-normal text-lg">
            Report a bug / suggest improvements and more features
          </span>
        </h3>
      </div>
      <Footer />
